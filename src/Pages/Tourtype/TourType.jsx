...
const TourType = () => {
    ...
    return (
        <div className="md:mt-8 mt-4 dark:bg-gradient-to-r dark:from-gray-800 dark:via-gray-600 dark:to-gray-500 dark:text-white">
            <h3 className="text-3xl text-center mb-2">Find Your Ideal Tour</h3>
    ...
    Let us help you find the perfect package for your dream getaway!
            ...
            <div className="text-center">
                <img className="opacity-90 rounded-2xl"  src={image1} alt="" data-aos='zoom-in'/>
               <Link to='/adventure'>
            ...
            <div className="text-center">
                <img className="opacity-90 rounded-2xl"  src={image2} alt="" data-aos='zoom-in'/>
                <Link to='/cultural'>
               <button className="btn px-4 pb-1 bg-green-500 -translate-y-12 text-2xl border-none">
               Cultural
                </button>
            ...
            <div className="text-center"> 
                <img className="opacity-90 rounded-2xl"  src={image3} alt="" data-aos='zoom-in'/>
                <Link to='/relaxation'>
               <button className="btn px-4 pb-1 bg-green-500 -translate-y-12 text-2xl border-none">
               Relaxation
                </button>
            ...
            <div className="text-center">
                <img className="opacity-90 rounded-2xl"   src={image4} alt="" data-aos='zoom-in'/>
                <Link to='/wildlife'>
               <button className="btn px-4 pb-1 bg-green-500 -translate-y-12 text-2xl border-none">
               Wildlife
                </button>
            ...
            <div className="text-center">
                <img className="opacity-90 rounded-2xl"  src={image5} alt="" data-aos='zoom-in'/>
                <Link to='/cruise'>
               <button className="btn px-4 pb-1 bg-green-500 -translate-y-12 text-2xl border-none">
               Cruise
                </button>
            ...
            <div className="text-center">
                <img className="opacity-90 rounded-2xl"  src={image6} alt="" data-aos='zoom-in'/>
                <Link to='/eco-tourism'>
               <button className="btn px-4 pb-1 bg-green-500 -translate-y-12 text-2xl border-none">
               Eco-Tourism
                </button>
