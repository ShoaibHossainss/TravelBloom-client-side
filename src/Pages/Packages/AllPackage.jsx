...
const AllPackage = () => {
  ...
  {allPackage.map((p) => (
    ...
    >
      <figure>
        <img className="relative" src={p.primary_image} alt="Package" />
      </figure>
      ...
      <div className="card-body">
        <h2 className="card-title text-rose-800 hover:text-pink-900 dark:text-rose-300 dark:hover:text-pink-400">
          Type: {p.tour_type}
        </h2>
        <p className="text-pink-800 hover:text-orange-900 dark:text-pink-300 dark:hover:text-orange-400">
          Title: {p.trip_title}
        </p>
        <p className="text-orange-800 hover:text-red-700 dark:text-orange-300 dark:hover:text-red-500">
          Price: {p.price}
        </p>
        <Link to={`/package-details/${p._id}`}>
          <div className="card-actions justify-end">
            <button className="btn btn-primary text-white bg-orange-500 hover:bg-orange-600 dark:bg-orange-600 dark:hover:bg-orange-700 border-none">
              View Package
            </button>
          </div>
        </Link>
